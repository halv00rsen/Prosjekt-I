...
public class CreateUser extends JPanel{
	...
	private void createUserInDatabase(){
		...
		JOptionPane.showMessageDialog(null, Database.addBruker(username, pass, adminCheckBox.isSelected()) ? "Du har nå opprettet en bruker!": "Brukeren ble ikke opprettet");
	}
