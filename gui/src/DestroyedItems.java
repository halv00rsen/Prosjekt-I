...
public class DestroyedItems extends JPanel{
	  ...
	  private static final String ADD_BUTTON_LABEL = "Legg til >>";

	  private static final String REMOVE_BUTTON_LABEL = "<< Fjern";

	  private static final String DEFAULT_SOURCE_CHOICE_LABEL = "Utstyr";

	  private static final String DEFAULT_DEST_CHOICE_LABEL = "Ødelagt utstyr";
